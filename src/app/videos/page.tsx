...
function Page() {
    ...
    const fetchPosts = async()=>{
        ...
        try {
            const res = await axios.post("/api/getPictures", {userIdFromSession, postType: "video"})
  ...
  return (
    ...
    //                        <div className='absolute top-0 h-12 flex justify-between items-center rounded-t-xl w-full '>
    //                        <div className='flex'>
    //                         <Image
    //                             src={profile}
    //                             width={10}
    ...
    <div className="h-screen overflow-y-scroll snap-y snap-mandatory">
        {visible ? (
            <div>
                {posts.map((post: PostType, index)=>(
                    <div key={index} className="h-screen snap-start  bg-black px-2 border-b-[1px] border-zinc-700 break-inside-avoid">
                        ...
                        controls muted loop playsInline
                        autoPlay
                        className=" h-[70vh] pt-5 rounded-lg shadow-md"
                        />

                        <div className='absolute top-0 pt-5 h-12 flex justify-between items-center rounded-t-xl w-full '>
                        <div className='flex'>
                        <Image
                            src={profile}
                            width={10}
