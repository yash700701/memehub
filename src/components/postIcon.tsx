...
function PostIcon() {
    ...
    try {
        ...
        // add coin
        const amount = 10;
        const description = "Post Created";
        try {
            axios.post('/api/addCoin', {userIdFromSession, amount, description })
            toast("🎉 10 coins have been credited to your wallet for posting!");
        } catch (error) {
            console.log("error in adding coin", error);
        }
    } catch (error) {
